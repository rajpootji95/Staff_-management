...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  void init() async {
   ...
   /* BitmapDescriptor.fromAssetImage(
       const  ImageConfiguration(platform: TargetPlatform.android), "images/maps/car_icon.png")
        .then((onValue) {
  ...
  LatLng destination = const LatLng(39.000000, -94.000000);
 Future <void> getLocation() async {
    ...
    await _store.getPolyPoints(_initialCameraPosition, destination);
